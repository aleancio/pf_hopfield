...
int main() {
  ...
  std::cout << "---- This is the pattern recognition section. Please follow "
  ...
  try {
    ...
    std::cout << "---- This is the pattern recognition section. Please follow "
                 "the instructions below ----\n\n";
    std::cout << "For demonstration purposes, the memory file used here is the "
                 "one generated by ModernLearn.\n";
    std::cout << "Please enter the absolute path to the file where memory is "
                 "stored (type '#' to use the default):\t";
    ...
    std::cout << "\n----------------------------------\n";
    std::cout << "Now we will load a corrupted pattern for recognition and "
                 "restoration.\n";
    std::cout
        << "For demonstration purposes, you may use an image from the same set "
           "used for training (type '#' to load an example image):\t";
    std::cin >> filePath;
    ...
    sf::RenderWindow window(sf::VideoMode(800, 600), "Modern Hopfield Network");
    ...
    while (window.isOpen()) {
      ...
      if (start) {
        if (!converged) {
          converged =
              net.restorePattern_withAnnealing(pattern.elaboratePattern(), n);
